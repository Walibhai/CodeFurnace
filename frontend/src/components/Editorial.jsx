...
const Editorial = ({ secureUrl, thumbnailUrl, duration }) => {
  ...
  const videoRef = useRef(null);//pause ,play ,current time ye sab kar sakte hn
  ...
  useEffect(() => {
    ...
    if (video) {
      video.addEventListener('timeupdate', handleTimeUpdate);//video ko handle ham js dom manupulation se karenge ieska koi way react mn nahi hn
